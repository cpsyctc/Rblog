...
At that point I could finally go for 
`make -j4`
...
make install 
```
puts R into /usr/local/lib.  To my surprise I had to copy the ./bin/R executable from the temporary directory to /usr/bin/R and then I was away:
R 4.0.4 up and running in what I think was less than an hour.
...
That's it!  R 4.0.4 installed on a Raspberry Pi 4 and I'm now much more confident that I compile subsequent releases on the machine too.
