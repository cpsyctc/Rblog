...
Hm.  Quite hard to digest that though it looks a.  What if I take mean values across all values of `n2`?
...
That that the Durlak approximation is worse than the Hedges one and that the Hedges approximation is pretty spot on with the bias of the full gamma transform.
...
I think we can ignore the Durlak approximation now.  What does removing it show?
...
So asymmetry impinges on the Durlak approximation but we know it's less good than the Hedges one. It doesn't look as if asymmetry, at least up to 3:1, is hurting the bias.
