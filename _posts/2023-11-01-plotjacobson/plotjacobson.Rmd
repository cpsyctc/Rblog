...
```
*[1.xi.23 This is work in progress and will evolve a lot over the next week and then get into CECPfuns R package on github. Latest updates 9.xi.23]*
...
```{r pointLabelling1, layout="l-body-outset"}
