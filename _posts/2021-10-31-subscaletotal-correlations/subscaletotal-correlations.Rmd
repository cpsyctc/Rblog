...
description: |
  A look at subscale/totall correlations in the null model
...
If the items scores are Gaussian and uncorrelated then it's not rocket science to work out that the asymptotic Pearson correlation (i.e. the correlation as the sample size tends to $\infty$) between the subscale score and the total score will be:
