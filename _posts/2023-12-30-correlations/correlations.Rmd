...
paste("Pearson correlation of the ranks of x and y is:", sprintf("%5.3f", cor(tibDat1N4$rankX, tibDat1N4$rankY)))
```

And ...

```{r Spearman2N4b, echo=TRUE}
### get the Spearman correlation by asking for it to be computed directly from raw data
paste("Spearman correlation of the raw values is:", sprintf("%5.3f", cor(tibDat1N4$x, tibDat1N4$y, method = "spearman")))
```
...
<center>
<div id="sfcf6nkxgdxp8248lmh6yza2p5m9lx971s8"></div><script type="text/javascript" src="https://counter11.optistats.ovh/private/counter.js?c=f6nkxgdxp8248lmh6yza2p5m9lx971s8&down=async" async></script><br><a href="https://www.freecounterstat.com">website hits counter</a><noscript><a href="https://www.freecounterstat.com" title="website hits counter"><img src="https://counter11.optistats.ovh/private/freecounterstat.php?c=f6nkxgdxp8248lmh6yza2p5m9lx971s8" border="0" title="website hits counter" alt="website hits counter"></a></noscript>
</div></center>

# History

* 30.xii.23: created 
* 7.viii.24: corrected "variances" to "SDs" in denominator of the Pearson coefficient
* 8.viii.24: improved the headings to map more sensibly to the [entry for the Pearson coefficient](https://www.psyctc.org/psyctc/glossary2/pearson-correlation-coefficient/) in [my glossary](https://www.psyctc.org/psyctc/book/glossary/) for Jo-anne's and my [OMbook](https://www.psyctc.org/psyctc/book/).
