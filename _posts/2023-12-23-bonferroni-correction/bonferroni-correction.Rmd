...
```
*[This post cross-links to several entries in the [glossary](https://www.psyctc.org/psyctc/book/glossary/) for our [OMbook](https://www.psyctc.org/psyctc/book/) (Evans, C., & Carlyle, J. (2021). Outcome measures and evaluation in counselling and psychotherapy (1st ed.). SAGE Publishing.)]*
